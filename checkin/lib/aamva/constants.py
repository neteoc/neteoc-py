...
AAMVA_VERSION_NUMBER_END_OFFSET = (
    AAMVA_VERSION_NUMBER_START_OFFSET + AAMVA_VERSION_NUMBER_LEN
)

JURISDICTION_VERSION_NUMBER_LEN = 2
JURISDICTION_VERSION_NUMBER_START_OFFSET = AAMVA_VERSION_NUMBER_END_OFFSET
JURISDICTION_VERSION_NUMBER_END_OFFSET = (
    JURISDICTION_VERSION_NUMBER_START_OFFSET + JURISDICTION_VERSION_NUMBER_LEN
)
