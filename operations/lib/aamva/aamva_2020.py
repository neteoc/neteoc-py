...
def parse_pdf417_data(pdf_417_raw_data: typing.List[str]):
    ...
    data_elements = {
            ...
            aamva_fields.DocumentExpirationDate(),
            aamva_fields.CustomerFamilyName(),
            aamva_fields.CustomerFirstName(),
            aamva_fields.CustomerMiddleName(),
            aamva_fields.DocumentIssueDate(),
            aamva_fields.DateOfBirth(),
            aamva_fields.PhysicalDescriptionSex(),
            aamva_fields.PhysicalDescriptionEyeColor(),
            aamva_fields.PhysicalDescriptionHeight(),
            aamva_fields.AddressStreet1(),
            aamva_fields.AddressCity(),
            aamva_fields.AddressJurisdictionCode(),
            aamva_fields.AddressPostalCode(),
            aamva_fields.CustomerIDNumber(),
            aamva_fields.DocumentDiscriminator(),
            aamva_fields.CountryIdentification(),
            aamva_fields.FamilyNameTruncation(),
            aamva_fields.FirstNameTruncation(),
            aamva_fields.MiddleNameTruncation(),
            aamva_fields.AddressStreet2(),
            aamva_fields.HairColor(),
            aamva_fields.PlaceOfBirth(),
            aamva_fields.AuditInformation(),
            aamva_fields.InventoryControlNumber(),
            aamva_fields.AliasFamilyName(),
            aamva_fields.AliasGivenName(),
            aamva_fields.AliasSuffixName(),
            aamva_fields.NameSuffix(),
            aamva_fields.PhysicalDescriptionWeightRange(),
            aamva_fields.RaceEthnicity(),
            aamva_fields.StandardVehicleClassification(),
            aamva_fields.StandardEndorsementCode(),
            aamva_fields.StandardRestrictionCode(),
            aamva_fields.JurisdictionSpecificVehicleClassificationDescription(),
            aamva_fields.JurisdictionSpecificEndorsementCodeDescription(),
            aamva_fields.JurisdictionSpecificRestrictionCodeDescription(),
            aamva_fields.ComplianceType(),
            aamva_fields.CardRevisionDate(),
            aamva_fields.HAZMAT_Endorsement_Expiration_Date(),
            aamva_fields.LimitedDurationDocumentIndicator(),
            aamva_fields.WeightPounds(),
            aamva_fields.WeightKilograms(),
            aamva_fields.Under18Until(),
    ...
    for idx, data_element in enumerate(data_elements):
        ...
        for line in pdf_417_raw_data:
            ...
            if len(regex_matches) > 1:
                ...
                parsed_data_dict[data_element.code] = field_data
...
def parse_ansi_field(ansi_field_txt: str) -> dict:
    ...
    aamva_version_number = ansi_field_txt[
    ...
    subfile_1_type = ansi_field_txt[
        constants.SUBFILE_1_TYPE_START_OFFSET : constants.SUBFILE_1_TYPE_END_OFFSET
    ]
    offset_1_field = ansi_field_txt[
        constants.OFFSET_1_FIELD_START_OFFSET : constants.OFFSET_1_FIELD_END_OFFSET
    ]
    length_1_field = ansi_field_txt[
        constants.LENGTH_1_FIELD_START_OFFSET : constants.LENGTH_1_FIELD_END_OFFSET
    ]
    subfile_2_type = ansi_field_txt[
        constants.SUBFILE_2_TYPE_START_OFFSET : constants.SUBFILE_2_TYPE_END_OFFSET
    ]
    offset_2_field = ansi_field_txt[
        constants.OFFSET_2_FIELD_START_OFFSET : constants.OFFSET_2_FIELD_END_OFFSET
    ]
    length_2_field = ansi_field_txt[
