...
class TimeEntry(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, help_text="User who performed the work"
    )
    organization = models.ForeignKey(
        IncidentOrganization,
        on_delete=models.CASCADE,
    ...
    activity_description = models.TextField(help_text="Description of the work performed")

    # Time tracking fields
    work_hours = models.DecimalField(
        max_digits=4, decimal_places=2, default=0, help_text="Hours spent on work activities"
    )
    volunteer_hours = models.DecimalField(
        max_digits=4, decimal_places=2, default=0, help_text="Hours spent on volunteer activities"
    )
    travel_hours = models.DecimalField(
        max_digits=4, decimal_places=2, default=0, help_text="Hours spent traveling"
    )
    travel_miles = models.DecimalField(
        max_digits=8, decimal_places=2, default=0, help_text="Miles traveled"
    )

    # Cost tracking fields
    travel_meal_costs = models.DecimalField(
        max_digits=8, decimal_places=2, default=0, help_text="Cost of meals during travel"
    )
    billeting_costs = models.DecimalField(
        max_digits=8, decimal_places=2, default=0, help_text="Cost of lodging/billeting"
    )
    purchases = models.DecimalField(
        max_digits=8, decimal_places=2, default=0, help_text="Cost of purchases made"
    )
